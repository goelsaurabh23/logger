...
/**
 * Basic test cases to check if same {@link AsyncSink} instance will be there in case same file location is given for different log levels
 * @author Saurabh
 */
public class AsyncSinkSingleInstanceTest {
	...
	@Test
	//Check if route info maps to async instance
	public void testRoutedSinkIsAsyncSink() {
